    ...
    <div class="container mt-5">
        <form action="instansi_view.php" class="form-instansi" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div> <img src="img/login.jpeg" alt="upload foto" style="width: 100px; height: 100px" class="rounded-circle"></div>
                <input type="file" class="form-control" id="image_instansi" name="image_instansi" accept="image/*">
            </div>
            <!-- Submit Button -->
            <div class="text-center mt-3">
                <button type="submit" name="tambah_instansi" class="btn btn-info w-100">Tambah Instansi</button>
            </div>
        </form>
