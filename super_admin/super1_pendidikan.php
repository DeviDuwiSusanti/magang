...
$sekolahData = [];
$rows = query("SELECT nama_pendidikan, jurusan FROM tb_pendidikan WHERE fakultas IS NULL");
...
$universitasData = [];
$perguruan_tinggi = query("SELECT DISTINCT * FROM tb_pendidikan WHERE fakultas IS NOT NULL");
