...
<div class="container mt-4">
    <h2 class="text-center"><i class="bi bi-gear"></i> Pengaturan</h2>
    ...
    <div id="akun" class="card p-4 mb-4">
        ...
        <form>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" value="Super Admin">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" value="superadmin@example.com">
            </div>
            <div class="mb-3">
