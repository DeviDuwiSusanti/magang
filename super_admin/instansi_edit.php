    ...
    <div class="container mt-5">
        <form action="instansi_view.php" class="form-instansi" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_instansi" name="nama_instansi" value="Diskominfo Sidoarjo" required>
            </div>
            <!-- Alamat Instansi -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="deskripsi_instansi" name="deskripsi_instansi" rows="3" > Diskominfo didirikan sejak  </textarea>
            </div>
            <!-- Telephone Instansi -->
            <div class="mb-3">
                <label for="telepon_instansi" class="form-label">Telepon Instansi</label>
                <input type="tel" class="form-control" id="telepon_instansi" name="telepon_instansi" value="098777882292" required>
            </div>
            <!-- Image Instansi -->
            <div class="mb-3">
